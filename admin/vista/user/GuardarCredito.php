...
<body>
    ...
    if ($conn->query($sqlcrear) === TRUE) {
        ...
        $file = fopen('C:\Users\Gabriel Leonardo Chu\Documents\proyectoanalisisdatos-master\apiAnalisis\Datasets\DatasetBanco\3.DatasetBanco.csv', 'a');  // 'a' for append to file - created if doesn't exit
