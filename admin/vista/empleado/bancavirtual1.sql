...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-07-2020 a las 16:44:36
...
INSERT INTO `bv_credito` (`cred_id`, `cred_cantidadc`, `cred_edad`, `cred_vivienda`, `cred_trabajoe`, `cred_empleo`, `cred_proposito`, `cred_tipoa`, `cred_meses`, `cred_historial`, `cred_monto`, `cred_tiempoem`, `cred_tasa`, `cred_evacasa`, `cred_activos`, `emp_id`, `cli_id`, `gar_id`, `cred_saldo`, `cred_estadocivil`, `cred_garantia`) VALUES
(20, 0, 24, 'A152', 'A202', 'A173', 'A42', 'francesa', 12, 'A30', '66767', 'A73', 10.84, '2444', 'A124', 3, 26, 25, 'A61', 'A93', 'A103');
...
(1, 11.10, '2020-06-11 05:08:32', 25),
...
--
ALTER TABLE `bv_credito`
  MODIFY `cred_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `bv_registrosacceso`
  MODIFY `reac_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT de la tabla `bv_transferencia`
--
ALTER TABLE `bv_transferencia`
  MODIFY `tra_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
...
ALTER TABLE `bv_credito`
  ...
  ADD CONSTRAINT `emp_id` FOREIGN KEY (`emp_id`) REFERENCES `bv_empleado` (`emp_id`),
