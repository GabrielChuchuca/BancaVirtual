...
if (!isset($_SESSION['isLogged']) || $_SESSION['isLogged'] === FALSE) {
    header("Location: /BancaVirtual/public/vista/login.html");
}
if ($usurol == 'admin') {
...
?>
    ...
    <body>
        ...
        $pass = MD5($contrasena);
        $codigo = 0;
        $sql = "INSERT INTO bv_persona VALUES(null,'$cedula', '$nombres', '$apellidos', '$direccion', '$telefono','$fecha','$correo','$estado','$sexo','empleado','$pass');";
        ...
        $conn->close();
        echo "<a href='/BancaVirtual/admin/vista/admin/index.php'>Regresar</a>";
        ?>
    </body>
